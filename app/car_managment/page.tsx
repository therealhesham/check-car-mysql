...
.logo {
    width: 100px; /* زيادة حجم اللوجو ليكون أكثر وضوحًا */
    height: auto;
    max-height: 80%; /* لضمان عدم تجاوز اللوجو لحجم الكارد */
    object-fit: contain; /* لضمان عرض اللوجو بشكل متناسب */
}
...
<div dir="rtl" className="relative">
    ...
    <div className="container mx-auto max-w-7xl">
        ...
        {selectedManufacturer ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {Object.keys(groupedCars).map((manufacturer) => {
                    // تطبيع اسم الشركة المصنعة إلى أحرف صغيرة لتطابق مسار الصورة
                                ...
                                <div className="cover">
                                    <img
                                        ...
                                        onError={(e) => {
                                            ...
                                            img.style.display = 'none'; // إخفاء اللوجو إذا فشل التحميل
                                            // إظهار النص كخيار احتياطي
                                    ...
                                    />
                                    {/* النص مخفي افتراضيًا ويظهر فقط إذا فشل تحميل اللوجو */}
