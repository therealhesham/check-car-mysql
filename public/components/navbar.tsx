...
// // تنسيق StyledWrapper لزر تسجيل الخروج
...
//   .text {
//     position: absolute;
//     left: 0%; /* تغيير من right إلى left للواجهة العربية */
//     width: 0%;
//     opacity: 0;
//     color: white;
//     font-size: 0.75em; /* تصغير حجم الخط ليناسب الحاوية */
//     font-weight: 600;
//     transition-duration: 0.3s;
...
//     width: 70%;
//     transition-duration: 0.3s;
//     padding-left: 8px; /* تقليل padding-left لتوفير مساحة */
//   }
